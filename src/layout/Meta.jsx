...
const Meta = () => (
  <Head>
    ...
    <meta property='og:description' content='Turing fullstack challenge 100% Gasy' />
    <meta property='og:title' content='Turing fullstack' />
    <meta property='og:url' content='http://turing-fullstack.herokuapp.com' />
    <meta property='og:image' content='http://turing-fullstack.herokuapp.com/static/og-image.jpg' />
